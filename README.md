...
Skill Set: A visual representation of my technical proficiencies.

Contact Section: Integrated links to my LinkedIn, GitHub, and email.

Smooth Scrolling: Enhanced user experience for easy navigation.
...
├── js/              # Interactivity scripts (script.js)
